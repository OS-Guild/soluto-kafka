...
public final class CallTargetGrpc {
    ...
    public abstract static class CallTargetImplBase implements io.grpc.BindableService {
        ...
        public final io.grpc.ServerServiceDefinition bindService() {
            return io
                .grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                .addMethod(
                    getCallTargetMethod(),
                    asyncUnaryCall(
    ...
    private static final class MethodHandlers<Req, Resp>
        ...
        public io.grpc.stub.StreamObserver<Req> invoke(io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) { default: throw new AssertionError(); }
        }
    }
            ...
            synchronized (CallTargetGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor =
                        result =
                            io
                                .grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
