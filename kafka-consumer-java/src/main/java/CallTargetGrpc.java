...
@javax.annotation.Generated(
    ...
    comments = "Source: kafkaMessage.proto")
public final class CallTargetGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<KafkaMessage.CallTargetPayload,
      KafkaMessage.CallTargetResponse> getCallTargetMethod;
  ...
  public static io.grpc.MethodDescriptor<KafkaMessage.CallTargetPayload,
      KafkaMessage.CallTargetResponse> getCallTargetMethod() {
    ...
    if ((getCallTargetMethod = CallTargetGrpc.getCallTargetMethod) == null) {
      synchronized (CallTargetGrpc.class) {
        if ((getCallTargetMethod = CallTargetGrpc.getCallTargetMethod) == null) {
          CallTargetGrpc.getCallTargetMethod = getCallTargetMethod =
              io.grpc.MethodDescriptor.<KafkaMessage.CallTargetPayload, KafkaMessage.CallTargetResponse>newBuilder()
   ...
   */
  public static CallTargetFutureStub newFutureStub(
      io.grpc.Channel channel) {
  ...
  /**
   */
  public static abstract class CallTargetImplBase implements io.grpc.BindableService {

    /**
     */
    public void callTarget(KafkaMessage.CallTargetPayload request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                KafkaMessage.CallTargetPayload,
                KafkaMessage.CallTargetResponse>(
                  this, METHODID_CALL_TARGET)))
          .build();
    }
  }
  ...
  public static final class CallTargetStub extends io.grpc.stub.AbstractStub<CallTargetStub> {
    ...
    @java.lang.Override
    protected CallTargetStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    public void callTarget(KafkaMessage.CallTargetPayload request,
        io.grpc.stub.StreamObserver<KafkaMessage.CallTargetResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getCallTargetMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CallTargetBlockingStub extends io.grpc.stub.AbstractStub<CallTargetBlockingStub> {
    ...
    @java.lang.Override
    protected CallTargetBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    public KafkaMessage.CallTargetResponse callTarget(KafkaMessage.CallTargetPayload request) {
      return blockingUnaryCall(
          getChannel(), getCallTargetMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class CallTargetFutureStub extends io.grpc.stub.AbstractStub<CallTargetFutureStub> {
    ...
    @java.lang.Override
    protected CallTargetFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<KafkaMessage.CallTargetResponse> callTarget(
      ...
      return futureUnaryCall(
          getChannel().newCall(getCallTargetMethod(), getCallOptions()), request);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CALL_TARGET:
          serviceImpl.callTarget((KafkaMessage.CallTargetPayload) request,
              (io.grpc.stub.StreamObserver<KafkaMessage.CallTargetResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CallTargetBaseDescriptorSupplier
